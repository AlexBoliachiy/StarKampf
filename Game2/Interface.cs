...
namespace Game2
{
    class Interface
    {
        ...
        public Map map;
        private const int screenWight = 1280; // вот это немного зашквар
        ...
        {
            int screenLeftDownX = (int)camera.Pos.X - screenWight / 2;
            int screenLeftDownY = (int)camera.Pos.Y + screenHeight / 2;


            DrawRectangle(new Rectangle(screenLeftDownX, screenLeftDownY - panelHeight, screenWight, panelHeight), Color.AliceBlue);
            //Рамку рисуем
            DrawLine(new Vector2(screenLeftDownX, screenLeftDownY), new Vector2(screenLeftDownX + screenWight, screenLeftDownY), Color.Blue);
            DrawLine(new Vector2(screenLeftDownX+ screenWight, screenLeftDownY-panelHeight), new Vector2(screenLeftDownX + screenWight, screenLeftDownY), Color.Blue);
            DrawLine(new Vector2(screenLeftDownX, screenLeftDownY-panelHeight), new Vector2(screenLeftDownX + screenWight, screenLeftDownY-panelHeight), Color.Blue);
            DrawLine(new Vector2(screenLeftDownX, screenLeftDownY), new Vector2(screenLeftDownX, screenLeftDownY-panelHeight), Color.Blue);
        }
